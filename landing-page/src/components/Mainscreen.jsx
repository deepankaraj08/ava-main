      ...
      >
        <div className="flex items-center gap-3">
          <a
            ...
            className="bg-gradient-to-r from-[#833AB4] via-[#FD1D1D] to-[#FCB045] hover:opacity-90 text-white rounded-2xl px-3 py-1 flex items-center gap-1.5 transition-all text-xs font-semibold shadow-sm"
          >
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="bg-[#25D366]/80 hover:bg-[#25D366] text-white rounded-2xl px-3 py-1 flex items-center gap-1.5 transition-colors text-xs font-semibold"
          >
            <svg viewBox="0 0 24 24" width="14" height="14" fill="currentColor" aria-hidden="true">
